...
class UserDetailsSceneRouter: NSObject, UserDetailsSceneRoutingLogic, UserDetailsSceneDataPassing {
    ...
    //func navigateToSomewhere(source: UserDetailsSceneViewController, destination: SomewhereViewController)
    //{
    ...
    //func passDataToSomewhere(source: UserDetailsSceneDataStore, destination: inout SomewhereDataStore)
    //{
