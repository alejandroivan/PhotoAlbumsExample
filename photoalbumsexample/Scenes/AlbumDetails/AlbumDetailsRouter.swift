...
class AlbumDetailsRouter: NSObject, AlbumDetailsRoutingLogic, AlbumDetailsDataPassing {
    ...
    //func navigateToSomewhere(source: AlbumDetailsViewController, destination: SomewhereViewController)
    //{
    ...
    //func passDataToSomewhere(source: AlbumDetailsDataStore, destination: inout SomewhereDataStore)
    //{
